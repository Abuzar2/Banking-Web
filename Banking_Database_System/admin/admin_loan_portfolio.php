...
// -----------------------------------------------------
// 1. Fetch ALL Loan Details (LOAN and BRANCH only)
// -----------------------------------------------------
$sql_loan = "
    SELECT 
        L.loan_number, 
...
<body>
    ...
    <div class="container">
        ...
        <h2>💰 Active Loans (Branch Data Only)</h2>
                ...
                <tbody>
                    <?php foreach ($loan_data as $loan): ?>
                        <tr>
                            ...
                            <td>
                                <!-- Link to point to the loan view page -->
                                <a href="admin_loan_view.php?loan_number=<?php echo htmlspecialchars($loan['loan_number']); ?>" class="action-link">View Details</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <?php else: ?>
            <p>No active loan records found in the database.</p>
        <?php endif; ?>
        <div class="back-link">
