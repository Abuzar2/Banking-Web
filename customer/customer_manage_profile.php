...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_profile'])) {
    ...
    if (!$cust_address || !$cust_phone_number || !$cust_city || !$cust_mobile_no) {
        ...
        // We update the address, city, phone_number, and mobile_no columns
...
// -----------------------------------------------------
// 2. Fetch Customer Data (Fix for 'cust_name' error is here)
// -----------------------------------------------------
// CORRECTED: Using 'first_name' and 'last_name' as per your schema.
        ...
        <div class="profile-card">
            ...
            <?php if ($customer_data): ?>
                ...
                <form method="POST" action="customer_manage_profile.php">
                    ...
                    <!-- Non-Editable Fields (Primary IDs/Immutable Info) -->
                    ...
                    <div class="form-group">
                        ...
                        <!-- Uses 'phone_number' from your schema -->
